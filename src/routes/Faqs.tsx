...
export default function Faqs() {
  return (
    <div className="faqs_container">
      ...
      <details>
        <summary>Who knew about the wedding??</summary> Just our parents, our
        siblings and their partners.
      </details>
      <ul className="faqs_questions">
        <li className="faqs_question">
          <p className="question">Who knew about the wedding??</p>
          <p className="answer">
        ...
        <li className="faqs_question">
          <p className="question">Is Devon pregnant?!</p>
          <p className="answer">No, I just like food.</p>
        </li>
        <li className="faqs_question">
          <p className="question">When are you having kids?</p>
          <p className="answer">30 Feb 1867</p>
        </li>
        <li className="faqs_question">
          <p className="question">How did David propose?</p>
